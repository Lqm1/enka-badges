...
const genshinMakeBadge = (extendedFormat: ExtendedFormat) => {
    const { logo: _, ...omittedFormat } = extendedFormat;
    const format: Format = omittedFormat;
    if (extendedFormat.logo === "genshin") {
        format.logoBase64 = logoBase64;
    }
